...
**"Find t using p-value"**: This is useful when you have a significance level or confidence level and need to 
...
**"Find p-value using t"**: This is useful when you want to determine the probability of observing a certain t value.
