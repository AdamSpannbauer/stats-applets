...
**"Find χ² using probability"**: This is useful when you have a significance level or confidence level and need to 
...
**"Find probability using χ²"**: This is useful to determine the probability of observing a certain χ² value.
